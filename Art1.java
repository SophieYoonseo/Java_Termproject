...
public class Art1 extends JFrame{    
	...
	JButton jb1 = new JButton("미술학과");
	JButton jb2 = new JButton("산업디자인학과");
	JButton jb3 = new JButton("음악과");
	JButton jb4 = new JButton("한국음악학과");
	...
	public Art1 (String name, String content) {
	...
	private void jbInit() throws Exception {
		...
		imgBox = new JLabel(new ImageIcon(Art1.class.getResource(name)));
	...
	class jb1Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Art1 eng1 = new Art1("예술대 신관.jpg", "미술학과.txt");    //Art1 메소드 호출
			eng1.show();
			dispose();                                                          
		}
	...
	class jb2Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Art1 eng1 = new Art1("예술대 신관.jpg", "산업디자인학과.txt");
			eng1.show();
			dispose();
		}
	...
	class jb3Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Art1 eng1 = new Art1("예술대 신관.jpg", "음악과.txt");
			eng1.show();
			dispose();
		}
	...
	class jb4Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Art1 eng1 = new Art1("예술대 신관.jpg", "한국음악학과.txt");
			eng1.show();
			dispose();
		}
