...
public class Science0 extends JFrame {
	...
	JButton jb1 = new JButton("수학과");
	JButton jb2 = new JButton("통계학과");
	...
	public Science0 (String name, String content) {
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("자연과학대학 본관");
     
		getContentPane().setLayout(null);

		imgBox = new JLabel(new ImageIcon(Engineering7.class.getResource("자연대본관.jpg")));
		imgBox.setBorder(border2);
		imgBox.setBounds(309, 28, 700, 300 );

	
		jb1.addMouseListener(new jb1Listener());  // "수학과"버튼에 마우스 리스너 달기
		jb2.addMouseListener(new jb2Listener());  // "통계학과"버튼에 마우스 리스너 달기
	...
	class jb1Listener implements MouseListener {  // "수학과" 마우스 리스너
		...
		public void mousePressed(MouseEvent e) {
			...
			Science0 sc0 = new Science0("자연대본관.jpg", "수학과.txt");
			sc0.show();
			dispose();
		}
	...
	class jb2Listener implements MouseListener {  // "통계학과" 마우스 리스너
		public void mouseClicked(MouseEvent e) {}
		public void mouseEntered(MouseEvent e) {}
		public void mouseExited(MouseEvent e) {
		...
		public void mousePressed(MouseEvent e) {
			...
			Science0 sc0 = new Science0("자연대본관.jpg", "통계학과.txt");
			sc0.show();
			dispose();
		}
		public void mouseReleased(MouseEvent e) {}
