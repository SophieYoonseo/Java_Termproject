...
public class Agriculture2 extends JFrame {
    ...
    JLabel imgBox, label2;   //imgBox = 건물사진, label2 : 학과 배너 
      ...
      JButton jb1 = new JButton("생물환경화학과");  //버튼으로 옆에 배너 만들기
      JButton jb2 = new JButton("원예학과");
      JButton jb3 = new JButton("작물생명과학과");
      ...
      public Agriculture2 (String name, String content) {
      ...
      private void jbInit() throws Exception {
         ...
         imgBox = new JLabel(new ImageIcon(Agriculture2.class.getResource(name)));
      ...
      class jb1Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture2 agi0 = new Agriculture2("농대2호관.jpg", "생물환경화학과.txt");    //Agriculture2 메소드 호출
            agi0.show();
            dispose();                                                          
         }
      ...
      class jb2Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture2 agi0 = new Agriculture2("농대2호관.jpg", "원예학과.txt");
            agi0.show();
            dispose();
         }
      ...
      class jb3Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture2 agi0 = new Agriculture2("농대2호관.jpg", "작물생명과학과.txt");
            agi0.show();
            dispose();
         }
