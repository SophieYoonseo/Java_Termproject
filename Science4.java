...
public class Science4 extends JFrame {
	...
	JButton jb1 = new JButton("분자생물학과");
	JButton jb2 = new JButton("지구환경과학과");
	...
	public Science4 (String name, String content) {
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("자연과학대학 4호관");
     
		getContentPane().setLayout(null);

		imgBox = new JLabel(new ImageIcon(Science4.class.getResource("자연대4호관.jpg")));
		imgBox.setBorder(border2);
		imgBox.setBounds(309, 28, 700, 300 );


		jb1.addMouseListener(new jb1Listener());  // "분자생물학과"버튼에 마우스 리스너 달기
		jb2.addMouseListener(new jb2Listener());  // "지구환경과학과"버튼에 마우스 리스너 달기
	...
	class jb1Listener implements MouseListener {  // "분자생물학과" 마우스 리스너
		...
		public void mousePressed(MouseEvent e) {
			...
			Science4 sc4 = new Science4("농대본관.jpg", "분자생물학과.txt");
			sc4.show();
			dispose();
		}
	...
	class jb2Listener implements MouseListener {  // "지구환경과학과" 마우스 리스너
		public void mouseClicked(MouseEvent e) {}
		public void mouseEntered(MouseEvent e) {}
		public void mouseExited(MouseEvent e) {
		...
		public void mousePressed(MouseEvent e) {
			...
			Science4 sc4 = new Science4("농대본관.jpg", "지구환경과학과.txt");
			sc4.show();
			dispose();
		}
		public void mouseReleased(MouseEvent e) {}
