...
public class Social extends JFrame {
	...
	JButton jb1 = new JButton("사회복지학과");
	JButton jb2 = new JButton("사회학과");
	JButton jb3 = new JButton("신문방송학과");
	JButton jb4 = new JButton("심리학과");
	JButton jb5 = new JButton("정치외교학과");
	JButton jb6 = new JButton("행정학과");
	...
	private void jbInit() throws Exception {
		...
		imgBox = new JLabel(new ImageIcon(Social.class.getResource("사회대.jpg")));
	...
	class jb1Listener implements MouseListener {  
		...
		public void mousePressed(MouseEvent e) {
			...
			Social lb1 = new Social("사회대.jpg", "사회복지학과.txt");
			lb1.show();
			dispose();
		}
	...
	class jb2Listener implements MouseListener {  
		...
		public void mousePressed(MouseEvent e) {
			...
			Social lb1 = new Social("사회대.jpg", "사회학과.txt");
			lb1.show();
			dispose();
		}
		public void mouseReleased(MouseEvent e) {}
	...
	class jb3Listener implements MouseListener {  
		...
		public void mousePressed(MouseEvent e) {
			...
			Social lb1 = new Social("사회대.jpg", "신문방송학과.txt");
			lb1.show();
			dispose();
		}
		public void mouseReleased(MouseEvent e) {
	...
	class jb4Listener implements MouseListener { 
		...
		public void mousePressed(MouseEvent e) {
			...
			Social lb1 = new Social("사회대.jpg", "심리학과.txt");
			lb1.show();
			dispose();
		}
		public void mouseReleased(MouseEvent e) {
	...
	class jb5Listener implements MouseListener { 
		...
		public void mousePressed(MouseEvent e) {
			...
			Social lb1 = new Social("사회대.jpg", "정치외교학과.txt");
			lb1.show();
			dispose();
		}
		public void mouseReleased(MouseEvent e) {
	...
	class jb6Listener implements MouseListener {
        ...
        public void mousePressed(MouseEvent e) {
           ...
           Social agi0 = new Social("사회대.jpg", "행정학과.txt");
           agi0.show();
           dispose();
        }
