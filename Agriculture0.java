...
import proj.Engineering1.jb1Listener;
import proj.Engineering1.jb2Listener;
import proj.Engineering1.jb3Listener;
import proj.Engineering1.jb4Listener;
import proj.Engineering1.jb5Listener;
import proj.Engineering1.jb6Listener;

public class Agriculture0 extends JFrame {
    ...
    JLabel imgBox, label2;   //imgBox = 건물사진, label2 : 학과 배너 
      ...
      JButton jb1 = new JButton("동물생명공학과");  //버튼으로 옆에 배너 만들기
      JButton jb2 = new JButton("산림환경과학과");
      JButton jb3 = new JButton("생명자원융합학과");
      JButton jb4 = new JButton("지역건설공학과");
      ...
      public Agriculture0 (String name, String content) {
      ...
      private void jbInit() throws Exception {
         ...
         imgBox = new JLabel(new ImageIcon(Agriculture0.class.getResource(name)));
      ...
      class jb1Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture0 agi0 = new Agriculture0("농대본관.jpg", "동물생명공학과.txt");    //Agriculture0 메소드 호출
            agi0.show();
            dispose();                                                          
         }
      ...
      class jb2Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture0 agi0 = new Agriculture0("농대본관.jpg", "산림환경과학과.txt");
            agi0.show();
            dispose();
         }
      ...
      class jb3Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture0 agi0 = new Agriculture0("농대본관.jpg", "생명자원융합학과.txt");
            agi0.show();
            dispose();
         }
      ...
      class jb4Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture0 agi0 = new Agriculture0("농대본관.jpg", "지역건설공학과.txt");
            agi0.show();
            dispose();
         }
