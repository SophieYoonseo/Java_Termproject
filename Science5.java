...
public class Science5 extends JFrame {
	...
	public Science5 (String name, String content) {
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("자연과학대학 5호관");
     
		getContentPane().setLayout(null);

		imgBox = new JLabel(new ImageIcon(Science5.class.getResource("자연대 5호관.jpg")));
		imgBox.setBorder(border2);
		imgBox.setBounds(309, 28, 700, 300 );

		jb1.addMouseListener(new jb1Listener());  // "물리학과"버튼에 마우스 리스너 달기
	...
	class jb1Listener implements MouseListener {  // "물리학과" 마우스 리스너
		...
		public void mousePressed(MouseEvent e) {
			...
			Science5 sc5 = new Science5("자연대 5호관.jpg", "물리학과.txt");
			sc5.show();
			dispose();
		}
