...
public class Education3 extends JFrame{    
	...
	JButton jb1 = new JButton("과학교육학부");
	...
	public Education3 (String name, String content) {
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("사범대 본관");
       
		getContentPane().setLayout(null);   


		imgBox = new JLabel(new ImageIcon(Education3.class.getResource(name)));
	...
	class jb1Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Education3 edu1 = new Education3("사범대 과학관.jpg", "과학교육학부.txt");    //Education1 메소드 호출
			edu1.show();
			dispose();                                                          
		}
