...
public class Science2 extends JFrame {
	...
	public Science2 (String name, String content) {
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("자연대2호관");
     
		getContentPane().setLayout(null);

		imgBox = new JLabel(new ImageIcon(Science2.class.getResource("자연대2호관.jpg")));
		imgBox.setBorder(border2);
		imgBox.setBounds(309, 28, 700, 300 );

		jb1.addMouseListener(new jb1Listener());  // "생명과학과"버튼에 마우스 리스너 달기
	...
	class jb1Listener implements MouseListener {  // "생명과학과" 마우스 리스너
		...
		public void mousePressed(MouseEvent e) {
			...
			Science2 sc2 = new Science2("자연대2호관.jpg", "생명과학과.txt");
			sc2.show();
			dispose();
		}
