...
public class Education1 extends JFrame{    
	...
	JButton jb1 = new JButton("국어교육과");  //버튼으로 옆에 배너 만들기
	JButton jb2 = new JButton("독어교육과");
	JButton jb3 = new JButton("수학교육과");
	JButton jb4 = new JButton("영어교육과");
	...
	public Education1 (String name, String content) {
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("사범대 3호관");
       
		getContentPane().setLayout(null);   


		imgBox = new JLabel(new ImageIcon(Education1.class.getResource(name)));
	...
	class jb1Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Education1 eng1 = new Education1("사범대 과학관.jpg", "국어교육과.txt");    //Education3 메소드 호출
			eng1.show();
			dispose();                                                          
		}
	...
	class jb2Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Education1 eng1 = new Education1("사범대 과학관.jpg", "독어교육과.txt");    //Education3 메소드 호출
			eng1.show();
			dispose();
		}
	...
	class jb3Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Education1 eng1 = new Education1("사범대 과학관.jpg", "수학교육과.txt");    //Education3 메소드 호출
			eng1.show();
			dispose();
		}
	...
	class jb4Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Education1 eng1 = new Education1("사범대 과학관.jpg", "영어교육과.txt");    //Education3 메소드 호출
			eng1.show();
			dispose();
		}
