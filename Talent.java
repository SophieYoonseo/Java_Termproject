...
public class Talent extends JFrame {
	...
	JButton jb1 = new JButton("공공인재학부");
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("글로벌인재관");
     
		getContentPane().setLayout(null);

		imgBox = new JLabel(new ImageIcon(Science5.class.getResource("글로벌 인재관 크기조정.jpg")));
		imgBox.setBorder(border2);
		imgBox.setBounds(309, 28, 700, 300 );

		jb1.addMouseListener(new jb1Listener());  // "공공인재학부"버튼에 마우스 리스너 달기
		...
		label2 = new JLabel("<html><br>학 과");   //개행문자
	...
	class jb1Listener implements MouseListener {  // "공공인재학부" 마우스 리스너
		...
		public void mousePressed(MouseEvent e) {
			...
			Talent t = new Talent("글로벌 인재관 크기조정.jpg", "공공인재학부.txt");
			t.show();
			dispose();
		}
