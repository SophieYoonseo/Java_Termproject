...
public class Agriculture3 extends JFrame {
    ...
    JLabel imgBox, label2;   //imgBox = 건물사진, label2 : 학과 배너 
      ...
      JButton jb1 = new JButton("농생물학과");  //버튼으로 옆에 배너 만들기
      JButton jb2 = new JButton("동물자원과학과");
      JButton jb3 = new JButton("조경학과");
      ...
      public Agriculture3 (String name, String content) {
      ...
      private void jbInit() throws Exception {
         ...
         imgBox = new JLabel(new ImageIcon(Agriculture3.class.getResource(name)));
      ...
      class jb1Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture3 agi0 = new Agriculture3("농대3호관.jpg", "농생물학과.txt");    //Agriculture0 메소드 호출
            agi0.show();
            dispose();                                                          
         }
      ...
      class jb2Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture3 agi0 = new Agriculture3("농대3호관.jpg", "동물자원과학과.txt");
            agi0.show();
            dispose();
         }
      ...
      class jb3Listener implements MouseListener {
         ...
         public void mousePressed(MouseEvent e) {
            ...
            Agriculture3 agi0 = new Agriculture3("농대3호관.jpg", "조경학과.txt");
            agi0.show();
            dispose();
         }
