...
public class Education4 extends JFrame{    
	...
	public Education4 (String name, String content) {
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("사범대 예체능관");
       
		getContentPane().setLayout(null);   

		imgBox = new JLabel(new ImageIcon(Education4.class.getResource(name)));
	...
	class jb1Listener implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			Education4 edu1 = new Education4("사범대 예체능관.jpg", "체육교육과.txt");    //Education2 메소드 호출
			edu1.show();
			dispose();                                                          
		}
